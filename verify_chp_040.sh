...
python inf_narco_app.py "C:\Data\stages\CHP040.edf" "{\"channel_indices\":{\"centrals\":[3,4],\"occipitals\":[5,6],\"eog_l\":7,\"eog_r\":8,\"chin_emg\":9}, \"show\":{\"plot\":false,\"hypnodensity\":false,\"hypnogram\":false,\"diagnosis\":true}, \"save\":{\"plot\":true,\"hypnodensity\":true, \"hypnogram\":true,\"diagnosis\":true}}"
