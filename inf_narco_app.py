...
from inf_hypnodensity import Hypnodensity  # from inf_extract_features import ExtractFeatures --> moved to inf_hypnodensity.py
...
def main(edfFilename, configInput): # configInput is object with additional settings.   'channel_indices', 'lightsOff','lightsOn'
...
if __name__ == '__main__':
    ...
    if sys.argv[2:]:  # if there are at least three arguments (two beyond [0])
